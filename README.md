...
[![开发交流群](https://img.shields.io/badge/开发交流-星乃の3番灵装·氪氪帝-brightgreen)](https://jq.qq.com/?_wv=1027&k=xCbUN4qb)
...
- 对于自行搭建、小范围私用的非营利性bot，若遇到任何部署、开发上的疑问，欢迎提交issue或加入[![开发交流群](https://img.shields.io/badge/开发交流-星乃の3番灵装·氪氪帝-brightgreen)](https://jq.qq.com/?_wv=1027&k=xCbUN4qb)讨论，我们欢迎有礼貌、描述详尽的提问！
...
等资源。自行收集可能较为困难，所以我们准备了一个较为精简的资源包以及下载脚本，可以满足公主连接相关功能的日常使用。如果需要，请加入QQ群 **星乃の3番灵装・氪氪帝** 813563151 或 **星乃の4番灵装・冰结傀儡** 711462207，下载群文件中的`res.zip`。
