...
class _PriconneData(object):
    CHARA = {   # id: [台服官译简体, 常见别称, 带错别字别称]
        ...
        1008: ['雪', '小雪', '镜子'],
        1009: ['杏奈', '中二', '煤气罐'],
        1010: ['真步', '狐狸', '真扎', 'maho', 'MAHO'],
        1011: ['璃乃', '妹弓'],
        1012: ['初音', 'hego', '星法', '星星法'],
        1013: ['七七香', '娜娜卡', '77k', '77香'],
        1014: ['霞', '侦探', '杜宾犬', '驴'],
        1015: ['美里', '圣母'],
        ...
        1070: ['似似花', '变貌大妃', '448', '捏捏卡'],
        1071: ['克里丝提娜', '誓约女君', '克总', '女帝', '克'],

        1073: ['尾狗刀', '尾刀狗'],

        1075: ['贪吃佩可(夏日)', '水吃', '水吃货'],
        1076: ['可可萝(夏日)', '水白', '水可可', '水可可萝', '水可可罗'],
        1077: ['铃莓(夏日)', '水女仆'],
        1078: ['凯留(夏日)', '水黑'],
        1079: ['珠希(夏日)', '水猫剑', '水猫'],
        1080: ['美冬(夏日)', '水子龙'],
        ...
        1111: ['镜华(万圣节)', '万圣镜华', '万圣xcw', '瓜仓唯', '瓜镜华'],
