...
1. 群初次使用时，需用命令初始化 `!建会 N<公会名> S<服务器地区>` 
!建会 Nリトルリリカル Sjp
!建会 N小小甜心 Stw
!建会 N今天版号批了吗 Scn
...
※命令一览表请见：github.com/Ice-Cirno/HoshinoBot/tree/master/hoshino/modules/priconne/clanbattle
'''
    await bot.send(ctx, msg, at_sender=True)
    await bot.send(ctx, R.img('priconne/quick/Hoshino会战.png').cqcode, at_sender=True)
