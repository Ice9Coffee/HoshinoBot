...
svtw = Service('pcr-news-tw', bundle='pcr订阅', help_='台服官网新闻', enable_on_default=False, visible=True)
svbl = Service('pcr-news-bili', bundle='pcr订阅', help_='B服官网新闻', enable_on_default=False, visible=True)
