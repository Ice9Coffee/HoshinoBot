...
CHARA_NAME = {
    ...
    1118: ["贪吃佩可(新年)", "ペコリーヌ(ニューイヤー)", "Pecorine(NewYear)", "春吃", "新吃", "新年吃货"],
    ...
    1147: ["矛依未(新年)", "ムイミ(ニューイヤー)", "Muimi(NewYear)", "新年511", "春511"],
    ...
    1702: ["环奈(振袖)", "カンナ(振袖)", "Kanna(Furisode)", "振袖环奈", "春环", "春奈", "春环奈", "二环"],
