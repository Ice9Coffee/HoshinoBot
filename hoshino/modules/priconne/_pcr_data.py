...
CHARA_NAME = {
    ...
    #=====2022年8月15日-日服更新=====
    1227: ["镜华(夏日)", "キョウカ(サマー)", "Kyouka(Summer)", "水仓唯", "泳装镜华", "泳装小仓唯", "scw"],
    1228: ["禊(夏日)", "ミソギ(サマー)", "Misogi(Summer)", "未奏希(夏日)", "水炸", "水炸弹人", "泳装炸弹人", "泳装未奏希"],
    1229: ["美美(夏日)", "ミミ(サマー)", "Mimi(Summer)", "水兔", "水美美", "泳装美美"],
