...
class _PriconneData:
    ...
    CHARA = {   
        ...
        1044: ["伊莉亚", "イリヤ", "Iriya", "伊利亚", "伊莉雅", "伊利雅", "yly"],
        ...
        1070: ["似似花", "ネネカ", "Neneka", "变貌大妃", "448", "捏捏卡", "变貌", "大妃"],
        ...
        1095: ["空花（大江户）", "クウカ（オーエド）", "Kuuka(Ooedo)", "江户空花", "江户抖m", "江m"],
        ...
        1107: ["碧（编入生）", "アオイ（編入生）", "Aoi(Hennyuusei)", "生菜", "新香菜"],
        1108: ["クロエ", "クロエ", "Curoe", "华哥"],
        1109: ["チエル", "チエル", "Chieru", "切露", "茄露", "茄噜", "切噜"],
        1110: ["ユニ", "ユニ", "Yuni"],
        1111: ["镜华（万圣节）", "キョウカ（ハロウィン）", "Kyouka(Halloween)", "万圣镜华", "万圣小仓唯", "万圣xcw", "猫仓唯", "黑猫仓唯", "猫cw", "猫唯", "猫仓", "喵唯"],
        1112: ["禊（万圣节）", "ミソギ（ハロウィン）", "Misogi(Halloween)", "万圣炸弹人", "瓜炸弹人"],
