...
async def follow_stream():
    ...
    async with client:
        ...
        users=cut_list(follow_screen_names,20)                                                      #处理数据，准备将config里follow所有人写入规则
        userqueue=""
        for user in users:
        ...
        fields = {
            "tweet.fields": ["created_at", "entities", "referenced_tweets","text","author_id","in_reply_to_user_id"],
